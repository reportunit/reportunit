                            ...
                            <div class='row dashboard'>
                                <div class='col s12 m6 l4'>
                                    <div class='card-panel'>
                                        <div title='Count of all passed tests'>Suite Summary</div>    
                                        <div class='chart-box'>
                                ...
                                <div class='col s12 m6 l4'>
                                    <div class='card-panel'>
                                        <div title='Count of all failed tests'>Tests Summary</div>
                                        <div class='chart-box'>
                                ...
                                <div class='col s12 m12 l4'>
                                    <div class='card-panel'>
                                        <div title='Count of all inconclusive tests'>Pass Percentage</div>
                                    ...
                                    <div class='col'>
                                        <div class='card-panel no-padding no-margin-v suite-list v-spacer'>
                                            <div class='filters card-panel'>
                                                ...
                                                <div>
                                                    <a title='Clear Filters' id='clear-filters' class='clear'><i class='mdi-navigation-close icon'></i></a> 
                                                </div> &nbsp;
                                                <div> 
                                                    <a title='Enable Dashboard' id='enableDashboard' class='enabled'><i class='mdi-action-track-changes icon active'></i></a> 
                                                </div>
                                            </div>
                                                ...
                                                @for (var ix = 0; ix < Model.TestSuiteList.Count; ix++)
                                                {
                                                    <li class='suite @Model.TestSuiteList[ix].Status.ToString().ToLower()'>
                                                        ...
                                                        <div class='suite-content hide'>
                                                            <span title='Suite started at time' class='startedAt label green lighten-2 text-white'>@Model.TestSuiteList[ix].StartTime</span>
                                                            @if (!String.IsNullOrEmpty(@Model.TestSuiteList[ix].EndTime))
                                                            {
                                                                <span title='Suite ended at time' class='endedAt label label brown lighten-2 text-white'>@Model.TestSuiteList[ix].EndTime</span>
                                                            }
